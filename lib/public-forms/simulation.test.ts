...
function snapshot(partial: Partial<PublicFormSnapshot> & { questions: PublicFormSnapshot["questions"] }): PublicFormSnapshot {
  return {
    ...
    rules: [],
    scoreBands: [],
    theme: { backgroundColor: "#fff", textColor: "#111", lineColor: "#eee" },
    ...
    const form = snapshot({
      questions: [
        ...
        },
        {
          ...
          required: true,
          position: 2,
          options: [{ label: "Amil", value: "Amil", score: 0 }],
          mappingTarget: "native_field",
        ...
        },
        {
          ...
          position: 3,
          options: [
            { label: "2 a 4 anos", value: "2 a 4 anos", score: 0 },
            { label: "Mais de 4 anos", value: "Mais de 4 anos", score: 0 },
          ],
        },
      ],
    })
