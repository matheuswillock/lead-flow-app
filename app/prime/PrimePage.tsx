...
function MeetingRow({
  ...
  return (
    <div className="flex items-start gap-3.5 py-3.5 border-b border-border last:border-0">
      ...
      >
        <span className="text-[9px] font-medium uppercase tracking-[.04em] text-white/80">{abbr}</span>
        ...
        <div className="prime-reveal border-b border-border bg-card" style={{ padding: "32px 24px" }}>
          ...
          <div>
            ...
            <MeetingRow
              ...
              gradOverride="linear-gradient(135deg, var(--prime-o1), var(--prime-o2))"
            />
            <MeetingRow
              abbr="quin"
              day="15/15"
              ...
              gradOverride="linear-gradient(135deg, #1A6FC4, #0C447C)"
            />
            <MeetingRow
              abbr="men"
              day="Mensal"
              ...
              gradOverride="linear-gradient(135deg, #2B7A4B, #1A5233)"
            />
          </div>
        </div>
