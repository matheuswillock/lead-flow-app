        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-5xl px-6 sm:px-8 lg:px-10 py-12 md:py-16">
            <div className="flex flex-col gap-6">
              <div
                className="rounded-2xl border p-6 shadow-xl backdrop-blur"
                style={{
              ...
              >
                ...
                <p className="mt-2 text-sm text-muted-foreground">Última atualização: 27/01/2026</p>
                <p className="mt-4 text-base text-muted-foreground">
                  Esta Política de Privacidade explica como o Corretor Studio coleta, usa e protege
                  seus dados ao utilizar a plataforma.
                </p>
              </div>
              ...
              <div className="grid gap-6">
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    Você pode solicitar acesso, correção ou exclusão dos seus dados. Entre em
                    contato pelo e-mail de suporte abaixo.
                  </p>
                </article>
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    ...
                    <a
                      ...
                      href="mailto:suporte@corretorstudio.com"
                    >
