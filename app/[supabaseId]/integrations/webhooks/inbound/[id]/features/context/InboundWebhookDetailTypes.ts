import type { IInboundWebhookDetailService } from "../services/IInboundWebhookDetailService";
 ...
 */
export type InboundWebhookDetailContextValue = {
  supabaseId: string;
  webhookId: string;
  listPath: string;
  service: IInboundWebhookDetailService;
};
