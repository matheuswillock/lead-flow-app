        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          <div className="flex h-12 shrink-0 items-center gap-1.5 bg-[#05050A] px-4">
            <Button
              ...
              variant="ghost"
              onClick={handleBack}
              className="whitespace-nowrap text-sm text-white/50 transition-colors hover:text-white/80"
            >
              Templates
            </Button>
            ...
            />
            <span className="rounded-md border border-[#232833] bg-[#111117] px-2 py-0.5 text-[11px] text-white/58">
              Draft
            </span>
            ...
            <div className="ml-2 flex shrink-0 items-center gap-1.5">
              ...
              <Button
                ...
                onClick={handleSave}
                disabled={saving}
                className="h-8 rounded-xl bg-white px-3 text-xs font-semibold text-black hover:bg-white/90"
              >
