...
export function mergeMessageFields(
  ...
  return {
    ...
    mediaMimeType: coalesceField(incoming.mediaMimeType, existing.mediaMimeType),
    storagePath: coalesceField(incoming.storagePath, existing.storagePath),
    mediaSha256: coalesceField(incoming.mediaSha256, existing.mediaSha256),
    mediaSizeBytes: coalesceField(incoming.mediaSizeBytes, existing.mediaSizeBytes),
    mediaStatus: coalesceField(incoming.mediaStatus, existing.mediaStatus),
