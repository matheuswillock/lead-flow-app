            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-6">
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    As assinaturas são processadas via Asaas. O acesso pode ser suspenso em caso de
                    inadimplência, conforme o plano contratado.
                  </p>
                </article>
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    O Corretor Studio oferece o serviço “como está” e não se responsabiliza por
                    perdas indiretas ou uso inadequado da plataforma.
                  </p>
                </article>
