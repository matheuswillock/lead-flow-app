...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const campaignIdsParam = searchParams.get("campaignIds") ?? searchParams.getAll("campaignId").join(",")
    ...
    const result = await emailAnalyticsUseCase.compareCampaigns({
    ...
    console.error("[EmailAnalyticsCompareRoute][GET]", error)
