...
export interface IManagerUserUseCase {
    ...
    createManager(data: { fullName: string; email: string; hasPermanentSubscription?: boolean; managerId?: string }): Promise<Output>;
    createOperator(data: { fullName: string; email: string; managerId: string; hasPermanentSubscription?: boolean }): Promise<Output>;
