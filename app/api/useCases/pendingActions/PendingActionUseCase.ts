...
const toBillingOwnerProfile = (action: ResolvedPendingAction): BillingOwnerProfile => ({
  ...
  asaasCustomerId: action.master.subscription?.asaasCustomerId ?? null,
  asaasSubscriptionId: action.master.subscription?.asaasSubscriptionId ?? null,
  subscriptionStatus: action.master.subscription?.subscriptionStatus ?? null,
  subscriptionNextDueDate: action.master.subscription?.subscriptionNextDueDate ?? null,
  subscriptionCycle: action.master.subscription?.subscriptionCycle ?? null,
  hasPermanentSubscription: action.master.subscription?.hasPermanentSubscription ?? false,
