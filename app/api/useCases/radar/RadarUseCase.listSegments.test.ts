...
const countSegments = mock(async () => {
...
const getMetrics = mock(async (_scope: unknown, precomputed: unknown) => {
...
mock.module("@/app/api/services/radar/RadarService", () => ({
  radarService: { countSegments, getMetrics },
}))

mock.module("@/app/api/services/radar/TeamRadarSegmentService", () => ({
...
mock.module("@/app/api/services/radar/RadarSegmentQueryService", () => ({
  radarSegmentQueryService: {
    countProfiles: mock(async () => 9),
  },
}))
