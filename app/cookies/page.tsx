            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <p className="mt-4 text-base text-muted-foreground">
                  Esta página explica como usamos cookies e tecnologias similares no Corretor
                  Studio.
                </p>
              </div>
              ...
              <div className="grid gap-6">
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    Você pode limpar ou bloquear cookies nas configurações do seu navegador. Algumas
                    funcionalidades podem não funcionar corretamente se os cookies forem
                    desativados.
                  </p>
                </article>
