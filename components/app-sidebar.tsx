...
import { LayoutDashboard, KanbanSquare, ChartBarBig, Users, HeartPulse, CalendarDays, Users2, Plug } from "lucide-react"
...
export function AppSidebar({ supabaseId, ...sidebarProps }: React.ComponentProps<typeof Sidebar> & { supabaseId?: string }) {
  ...
  const items = [
    ...
    { title: "Integracoes", url: `/${supabaseId}/integrations`, icon: Plug, managerOnly: true },
    { 
