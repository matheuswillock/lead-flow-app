...
export function PublicFormRenderer({ snapshot, publicId, preview = false, className }: Props) {
  ...
  return (
    <div
      className={cn(
        "public-form-page flex w-full flex-col justify-center bg-background text-foreground [color-scheme:light]",
    ...
    <FieldGroup className="gap-4 sm:grid sm:grid-cols-2">
      <Field>
        ...
        <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
          ...
          <PopoverContent className="public-form-page w-auto p-0" align="start">
            <Calendar
              mode="single"
      ...
      <Field>
        ...
        >
          ...
          <SelectContent className="public-form-page">
