...
import type { MessagingContactLookup } from "./types"
...
function parseSegments(text: string, contactLookup?: MessagingContactLookup): TextSegment[] {
...
interface MessagingFormattedTextProps {
  text: string
...
export function MessagingFormattedText({
  text,
  variant = "inbound",
  contactLookup,
  className,
}: MessagingFormattedTextProps) {
