...
-- Idempotente: cada lead em bloco BEGIN/EXCEPTION unique_violation
-- (cobre leadCode e @@unique(teamId, email)); schedule por leadId único.
...
BEGIN
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'M936194R';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'S7021A';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'C71388A';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'M347913I';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'A41770I';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'A882288Z';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'F492022A';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'C48723E';
  END;
  ...
  EXCEPTION
    WHEN unique_violation THEN
      RAISE NOTICE 'Skip restore % (unique leadCode ou teamId+email)', 'C34630E';
  END;
