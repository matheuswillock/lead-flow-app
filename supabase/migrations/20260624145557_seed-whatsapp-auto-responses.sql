-- Insert whatsapp-auto-responses child feature under whatsapp parent
...
-- Insert access rules for whatsapp-auto-responses (manager+ only)
DO $$
DECLARE v_id uuid;
BEGIN
  SELECT "id" INTO v_id FROM "public"."backoffice_features" WHERE "slug" = 'whatsapp-auto-responses';
